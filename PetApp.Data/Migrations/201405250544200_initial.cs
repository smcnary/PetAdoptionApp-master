namespace PetApp.Data.Migrations
{
    ...
    public partial class initial : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Schedules", "VolunteerId", "dbo.Volunteers");
            DropForeignKey("dbo.Schedules", "PetId", "dbo.Pets");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropIndex("dbo.AspNetUserLogins", new[] { "UserId" });
            DropIndex("dbo.AspNetUserClaims", new[] { "UserId" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.Schedules", new[] { "PetId" });
            DropIndex("dbo.Schedules", new[] { "VolunteerId" });
